...
if (CMAKE_SYSTEM_NAME MATCHES "Darwin")
  ...
  if (CMAKE_HOST_SYSTEM_VERSION VERSION_GREATER_EQUAL 20
      AND CMAKE_HOST_SYSTEM_VERSION VERSION_LESS 22)
  ...
  set(LUAJIT_C_COMPILER CC=${CMAKE_C_COMPILER})
...
ExternalProject_Add(luajit
  ...
  BUILD_COMMAND $(MAKE) ${LUAJIT_C_COMPILER} ${DEPLOYMENT_TARGET} CFLAGS=${CFLAGS} BUILDMODE=static "XCFLAGS=-fPIC"
