...
#define FLB_ENGINE_EV_RELOADING FLB_BITS_U64_SET(1, 5) /* Engine reloading  */
#define FLB_ENGINE_EV_RELOAD    FLB_BITS_U64_SET(1, 6) /* Engine reload     */
...
#define FLB_ENGINE_RELOADING    FLB_BITS_U64_LOW(FLB_ENGINE_EV_RELOADING)
#define FLB_ENGINE_RELOAD       FLB_BITS_U64_LOW(FLB_ENGINE_EV_RELOAD)
...
#define FLB_ENGINE_PRIORITY_RELOAD      FLB_ENGINE_PRIORITY_TOP
